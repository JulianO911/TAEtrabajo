...
```
```{r}
save(accidentes, "accidentesMDE.RData")
save(accFechaDis, "accFechaDiseno.RData")
save(accFechaAcc, "accFechaTipo.RData")
save(accFechaDisAcc, "accFechaDisenoTipo.RData")
```
