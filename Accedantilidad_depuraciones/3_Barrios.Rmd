...
barriosAux <- incidentes %>% # Vector con todos los barrios de la BD
  select(c(BARRIO))
...
```{r}
incidentes$BARRIO[incidentes$BARRIO == "Sin Inf"] <- NA
incidentes$BARRIO[incidentes$BARRIO == "Sin Nombre"] <- NA
incidentes$BARRIO[incidentes$BARRIO == ""] <- NA
incidentes$BARRIO[incidentes$BARRIO == "Inst"] <- NA
incidentes$BARRIO[incidentes$BARRIO == "0"] <- NA
```
