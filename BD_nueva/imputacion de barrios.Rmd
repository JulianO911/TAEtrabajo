...
```{r include=FALSE}
source_python("imputación_de_barrios_en_python.py")
accidentes <- lecturaDatos("accidentesMDE2.csv")
...
```{r include=FALSE}
accidentes <-read.csv("accidentesConBarrio3.csv", header = TRUE, sep = ",", dec = ".", encoding = "UTF-8")
```
