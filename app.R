                ...
                navbarPage(
                  ...
                  "),
                           sidebarPanel(
                             ...
                             selectInput("InputCLASE_ACCIDENTE", "Clase de accidente:", choices=c("Todos","Atropello","Caida del ocupante",
                                                                                                  "Choque", "Incendio", "Otro", "Volcamiento")),
                             selectInput("InputGRAVEDAD_ACCIDENTE", "Gravedad del accidente:", choices=c("Todos","Con heridos","Con muertos","Solo danos"))
...
server <- function(input, output) {
  ...
  #accidentesFilter <- accidentes# Corregir
  ...
  load("www/funcion_modelo.RData")
  modeloYPlotChoque <-  defModeloyPlot("Choque",4,11,accFechaAcc)
  modeloYPlotAtropello <- defModeloyPlot("Atropello",4,6,accFechaAcc)
  modeloYPlotVolcamiento <- defModeloyPlot("Volcamiento",6,12,accFechaAcc)
  modeloYPlotCaida <- defModeloyPlot("Caida del ocupante",6,12,accFechaAcc)
  modeloYPlotIncendio <- defModeloyPlot("Incendio",2,1,accFechaAcc)
  modeloYPlotOtro <- defModeloyPlot("Otro",3,13,accFechaAcc)
